...
public class JWTUtil {
     ...
     * @param sysUser   登录成功的user对象
     * @return
     */
    public static String createJWT(long ttlMillis, SysUser sysUser) {
        ...
        claims.put("id", sysUser.getId().toString());
     ...
     * @return
     */
    public static Claims parseJWT(String token, SysUser sysUser) {
        // 签名秘钥，和生成的签名的秘钥一模一样
        String key = sysUser.getPassword();
